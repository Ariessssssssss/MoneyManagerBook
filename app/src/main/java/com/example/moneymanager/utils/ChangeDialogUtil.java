...
import com.example.moneymanager.adapter.RecordPagerAdapter;
import com.example.moneymanager.frag_record.IncomesFragment;
import com.example.moneymanager.frag_record.PayoutFragment;
...
public class ChangeDialogUtil extends DialogFragment implements View.OnClickListener {
    ...
    /*public ChangeDialogUtil(@NonNull Context context) {
        super();
    }*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout = findViewById(R.id.dialog_change_tabs);
        viewPager = findViewById(R.id.dialog_change_vp);
        imageView = findViewById(R.id.dialog_change_iv_back);
        initPager();
