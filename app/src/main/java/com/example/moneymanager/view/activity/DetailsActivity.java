...
import com.example.moneymanager.view.adapter.ChartVPAdapter;
import com.example.moneymanager.model.dao.DBManager;
import com.example.moneymanager.view.fragment.frag_chart.IncomeBarChartFragment;
import com.example.moneymanager.view.fragment.frag_chart.PayoutBarChartFragment;
import com.example.moneymanager.view.dialog.TimeDialogUtil;
...
public class DetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initDatas(int year,int month) {
        float inSumMoneyOneMonth = detailsController.getMonthlySum(year, month, 1);
        float outSumMoneyOneMonth = detailsController.getMonthlySum(year, month, 0);
        int inCountItemOneMonth = detailsController.getMonthlyCountItem(year, month, 1);
        int outCountItemOneMonth = detailsController.getMonthlyCountItem(year, month, 0);
