...
import com.example.moneymanager.view.activity.ChartActivity;
import com.example.moneymanager.view.activity.HistoryActivity;
import com.example.moneymanager.R;
import com.example.moneymanager.view.activity.SettingActivity;
...
public class MoreDialogUtil extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId()==R.id.dialog_more_btn_details) {
            intent.setClass(getContext(), ChartActivity.class);
            getContext().startActivity(intent);
        }
